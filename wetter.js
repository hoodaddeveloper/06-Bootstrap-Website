...
async function getWeather(city) {
  ...
  app.innerHTML = `
    <div class="card">
      <div class="wetter"><i style="font-size:3rem;" class="wi ${today.symbol}"></i></div>
      <div class="card-body text-center"><h2>${City}</h2><small class="my-3 d-block">${today.condition}</small><div>
